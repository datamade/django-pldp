...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='location',
            name='area',
            field=models.ForeignKey(help_text='Polygon that describes the geometry of the location', on_delete=django.db.models.deletion.CASCADE, to='location.LocationArea'),
        ),
        migrations.AddField(
            model_name='location',
            name='country',
        ...
        migrations.AddField(
            model_name='location',
            name='line',
            field=models.ForeignKey(help_text='Line that describes the geometry of the location', on_delete=django.db.models.deletion.CASCADE, to='location.LocationLine'),
        ),
    ]
